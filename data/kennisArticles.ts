...
Dit creëert een situatie waarin het slachtoffer bij een vertrek direct dakloos of in diepe schulden terechtkomt, een realiteit die de dader bewust in stand houdt om zijn macht te borgen.`,
  ...
  },
  {
    ...
    content: {
      ...
      analysis: `Sweet(2019) beschrijft dit als de 'internalisering' van de aanval op de realiteit.Het slachtoffer stelt zichzelf constant vragen: * "Reageer ik niet inderdaad te emotioneel?" * of * "Heb ik het wel goed onthouden?" *

** De gevolgen:**
*   ** Cognitieve Dissonantie:** Een constante strijd tussen wat je * ziet * en wat je wordt * verteld *.
