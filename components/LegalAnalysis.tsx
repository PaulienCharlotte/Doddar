      ...
      <div className={`p-4 rounded-lg flex items-start gap-4 mb-4 ${is_bevoegd ? 'bg-status-safe/10 border border-status-safe/30' : 'bg-status-warning/10 border border-status-warning/30'}`}>
          ...
          <div className="flex-grow">
              ...
              <div className="flex items-center gap-1.5 mt-2">
                  ...
                  <Tooltip content="Als erkend recherchebureau toetst Doddar of er een 'gerechtvaardigd belang' is voor een onderzoek. Deze AI-indicatie vervangt geen formele intake door een bevoegd onderzoeker.">
