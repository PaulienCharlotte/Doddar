...
const ResultDisplay: React.FC<ResultDisplayProps> = ({ result, onReset, onRequestIntake }) => {
  ...
  return (
    <div className="space-y-12 animate-fade-in max-w-5xl mx-auto pb-24 px-4">
        ...
        {/* Dossier Header Info - Removed Reference Number for Anonymity */}
        ...
        {/* 2. Gedrag & Wetenschap Section */}
        <section className="space-y-8">
            <div className="flex items-center gap-4 mb-4">
                <div className="h-px bg-brand-accent flex-grow"></div>
                <span className="text-[10px] font-bold text-brand-subtle uppercase tracking-[0.3em]">II. Gedragsanalyse & Context</span>
                <div className="h-px bg-brand-accent flex-grow"></div>
            </div>
        ...
        {/* 3. Juridische Analyse Section */}
        <section className="space-y-8">
            <div className="flex items-center gap-4 mb-4">
                <div className="h-px bg-brand-accent flex-grow"></div>
                <span className="text-[10px] font-bold text-brand-subtle uppercase tracking-[0.3em]">III. Juridisch Kader</span>
                <div className="h-px bg-brand-accent flex-grow"></div>
            </div>
        ...
        {/* 4. EXPERT GATE: Informatie-doserig (Bescherming van IP) */}
        <section className="bg-[#13261f] text-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#58B895]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
            <div className="relative z-10 grid md:grid-cols-[1fr_200px] gap-8 items-center">
                <div className="space-y-4">
                    <div className="flex items-center gap-3 text-[#58B895]">
                        <BrainIcon className="w-6 h-6" />
                        <h3 className="text-xl font-bold uppercase tracking-wider text-sm">Diepere Redenering Onderbroken</h3>
                    </div>
                    <h4 className="text-2xl md:text-3xl font-bold leading-tight">Expert-validatie vereist voor diepgaande conclusies.</h4>
                    <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                        De AI heeft patronen gedetecteerd die wijzen op complexe machtsdynamieken en mogelijke bewijslast. Om misinterpretatie van deze gevoelige informatie te voorkomen, worden de meest gedetailleerde kruisverbanden pas ontsloten na een <strong>menselijke validatie</strong> door een erkend onderzoeker.
                    </p>
                </div>
                <div className="hidden md:flex justify-center">
                    <div className="w-32 h-32 rounded-full border-4 border-[#58B895]/30 flex items-center justify-center animate-pulse">
        ...
        {/* 5. Advies & Reflectie Section */}
        <section className="space-y-8">
            <div className="flex items-center gap-4 mb-4">
                <div className="h-px bg-brand-accent flex-grow"></div>
                <span className="text-[10px] font-bold text-brand-subtle uppercase tracking-[0.3em]">IV. Advies & Reflectie</span>
                <div className="h-px bg-brand-accent flex-grow"></div>
            </div>
        ...
        {/* 6. Onderzoeksmethoden Section (The Solution) */}
        <section className="pt-12">
            <div className="flex items-center gap-4 mb-12">
                <div className="h-px bg-brand-accent flex-grow"></div>
                <span className="text-[10px] font-bold text-brand-subtle uppercase tracking-[0.3em]">V. Onderzoeksstrategie</span>
                <div className="h-px bg-brand-accent flex-grow"></div>
            </div>
