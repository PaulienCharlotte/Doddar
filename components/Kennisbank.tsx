  ...
  return (
    <div className="min-h-screen bg-[#F9FCFA] animate-fade-in pb-24 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-0 w-1/2 h-full opacity-5 pointer-events-none -z-0">
          <img src="https://raw.githubusercontent.com/PaulienCharlotte/Doddar/refs/heads/main/images/kennis%20earth%20trans.svg" alt="" className="absolute top-10 right-10 w-64 h-64 animate-slow-float" />
          <img src="https://raw.githubusercontent.com/PaulienCharlotte/Doddar/refs/heads/main/images/kennis%20DNA%20trans.svg" alt="" className="absolute bottom-40 right-40 w-48 h-48 rotate-12" />
      </div>

      <section className="relative pt-16 pb-12 max-w-5xl mx-auto px-6 text-center z-10">
          <span className="inline-block py-1 px-4 rounded-full bg-[#E8F5EF] border border-[#58B895]/20 text-[#58B895] text-xs font-bold uppercase tracking-widest mb-8">Kenniscentrum</span>
          <h1 className="text-3xl md:text-5xl lg:text-6xl text-[#13261f] font-medium leading-tight italic">“Onderbouwing is de brug tussen vermoeden en zekerheid.”</h1>
      </section>

      {/* Main Container */}
      <div className="max-w-7xl mx-auto px-4 space-y-12 mb-24 z-10 relative">
        
        {/* Scientific Integrity Block */}
        <div className="bg-[#E8F5EF]/40 border border-[#58B895]/30 rounded-[2rem] p-6 md:p-10 flex flex-col md:flex-row items-center gap-8 shadow-sm">
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-[#58B895] shadow-md flex-shrink-0">
                <InfoIcon className="w-8 h-8" />
            </div>
            <div className="space-y-3">
                <h2 className="text-sm font-bold text-[#13261f] uppercase tracking-widest">Wetenschappelijk Fundament</h2>
                <p className="text-brand-text text-base md:text-lg leading-relaxed font-light">
                    De informatie in deze kennisbank is uitsluitend gebaseerd op onafhankelijke wetenschappelijke studies en juridische kaders. De inhoud representeert feitelijke bevindingen uit de psychologie en rechtswetenschap en betreft <span className="font-bold text-[#13261f] underline decoration-[#58B895] decoration-2 underline-offset-4">geen persoonlijke mening</span> of advies van Doddar.
                </p>
            </div>
        </div>

        {/* Search & Filter Controls with Brain Image Positioning Fix */}
        <div className="bg-white rounded-[2rem] md:rounded-[3rem] border border-[#E5E7EB] shadow-xl overflow-hidden">
            <div className="grid lg:grid-cols-[1.5fr_1fr] items-center">
                ...
                {/* Fixed Brain Image Column */}
                <div className="hidden lg:flex justify-center items-center bg-[#F2F9F6] h-full p-12">
                    <img src="https://raw.githubusercontent.com/PaulienCharlotte/Doddar/refs/heads/main/images/kennis%20brein.svg" alt="" className="w-full max-w-[280px] h-auto drop-shadow-2xl hover:scale-105 transition-transform duration-700" />
                </div>
            </div>
        </div>
      </div>
